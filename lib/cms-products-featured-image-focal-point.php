...
if (!function_exists('cms_products_get_featured_image_focal_point')) {
    function cms_products_get_featured_image_focal_point($post_id)
    {
        ...
        return [
            'x' => max(0, min(100, $focus_x)),
            'y' => max(0, min(100, $focus_y)),
        ];
    }
}

if (!function_exists('cms_products_get_featured_image_object_position')) {
    function cms_products_get_featured_image_object_position($post_id)
    {
        $focal_point = cms_products_get_featured_image_focal_point($post_id);

        return $focal_point['x'] . '% ' . $focal_point['y'] . '%';
    }
}
...
if (!function_exists('cms_products_render_featured_image_focal_point_metabox')) {
    function cms_products_render_featured_image_focal_point_metabox($post)
    {
        ...
        $focal_point = cms_products_get_featured_image_focal_point($post->ID);
