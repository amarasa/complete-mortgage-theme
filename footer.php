<footer>
    ...
    <div class="top-footer bg-topFooter pt-14 pb-2">
    ...
    <div class="bottom-footer bg-bottomFooter pt-7 md:pb-10">
        <div class="container px-8">
    ...
    <div class="legal-footer bg-bottomFooter pb-0 text-xs text-[#c7c7c7]">
        <div class="container px-8">
