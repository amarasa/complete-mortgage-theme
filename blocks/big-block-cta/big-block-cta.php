...
?>
<section id="<?php echo esc_attr($block_id); ?>" class="my-12 big-block-cta overflow-hidden relative <?php echo esc_attr($edge_to_edge ? 'w-full' : 'md:container mx-auto'); ?> <?php echo esc_attr(!$edge_to_edge ? $corners : ''); ?> p-12 bg-primary text-white text-center" data-block-name="<?php echo esc_attr($acfKey); ?>">
