...
?>
<section id="<?php echo esc_attr($block_id); ?>" class="big-block-cta overflow-hidden relative my-12 <?php echo esc_attr($edge_to_edge ? 'w-full' : 'md:container mx-auto'); ?> <?php echo esc_attr(!$edge_to_edge ? $corners : ''); ?> bg-primary text-white text-center" data-block-name="<?php echo esc_attr($acfKey); ?>">
    ...
    <?php endif; ?>
    <div class="big-block-cta-content relative z-20 px-8">
