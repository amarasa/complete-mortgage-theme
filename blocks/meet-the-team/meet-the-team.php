...
<section class="meet-the-team <?php echo esc_attr($classes); ?>" <?php echo $id; ?> data-block-name="<?php echo esc_attr($acfKey); ?>">
    <div class="container px-8">
        ...
        <?php if ($team_members->have_posts()):
            ...
            $schema_position = 1;
        ?>
            <div class="md:flex md:flex-wrap justify-center gap-y-8 md:gap-x-8">
                ...
                ?>
                    <div class="mb-8 md:w-1/3 lg:w-[20%]">
                        <?php if ($clickable): ?><a href="<?php echo esc_url($profile_url); ?>" class="group block relative"><?php endif; ?>
                            <div class="w-full relative aspect-[4/4] overflow-hidden <?php echo esc_attr($corners); ?>">
                                ...
                                <?php else: ?>
                                    <img src="https://via.placeholder.com/150"
                                        ...
                                        decoding="async">
                                <?php endif; ?>
                                <div class="bg-black absolute inset-0 <?php echo esc_attr($corners); ?> opacity-0 <?php echo $clickable ? 'group-hover:opacity-40' : 'hover:opacity-40'; ?> transition-all duration-300 ease-in-out"></div>
                                <?php if ($clickable): ?>
                                    <span class="absolute inset-0 z-20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                                        <span class="bg-white text-secondary font-semibold px-6 py-2 rounded-lg">Learn More</span>
                                    </span>
                                <?php endif; ?>
                            </div>
                            <?php if ($clickable): ?>
