                ...
                <?php if ($card_link) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="eh-productcardcontent product-card-content border-[1px] border-solid border-[#c6c6cd] pt-6 pb-8 bg-white flex flex-col <?php if ($rounded_corners == true) { ?>rounded-b-md<?php } ?>">
                            <h3 class="px-8 !mb-0 !pb-0 eh-productcardtitle product-card-title text-xl"><?php echo esc_html($card_title); ?></h3>
                            <div class="px-8 eh-productcarddescription text-[#444] product-card-description mb-0"><?php echo wp_kses_post($card_description); ?></div>
                            <?php if ($card_link) { ?>
