...
<section class="product-cards relative <?php if ($solid_color && !$solid_color_or_background_image) {
            ...
            <?php while (have_rows('product_cards')) : the_row();
                ...
                $product_schema_item = [
                    ...
                    "item" => [
                        ...
                        "name" => $card_title,
                        "description" => wp_strip_all_tags((string) $card_description),
                        "provider" => [
                            "@type" => "Organization",
            ...
            ?>
                <?php if ($card_link) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <?php endif; ?>
                        <div class="product-card-content border-[1px] border-solid border-[#c6c6cd] pt-6 pb-8 bg-white flex flex-col <?php if ($rounded_corners == true) { ?>rounded-b-md<?php } ?>">
                            <h3 class="px-8 !mb-0 !pb-0 product-card-title text-xl"><?php echo esc_html($card_title); ?></h3>
                            <div class="px-8 text-[#444] product-card-description wysiwyg mb-0"><?php echo wp_kses_post($card_description); ?></div>
                            <?php if ($card_link) { ?>
