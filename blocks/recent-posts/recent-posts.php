...
$see_more_articles_link = get_field('see_more_articles_link');
$recent_posts_spacing_class = empty($see_more_articles_link) ? ' !pb-[15px] md:!pb-[30px]' : '';
...
<section class="recent-posts<?php echo esc_attr($recent_posts_spacing_class); ?> <?php echo esc_attr($classes); ?>" <?php echo $id; ?> data-block-name="<?php echo esc_attr($acfKey); ?>">
