...
<section class="apply-online <?php echo esc_attr($classes); ?>" <?php echo $id; ?> data-block-name="<?php echo esc_attr($acfKey); ?>">
    <div class="<?php if ($overlap) { ?>overlap<?php } ?> sm:container bg-grey px-8 py-12 lg:py-16 <?php if ($corners) { ?>sm:rounded-2xl<?php } ?>">
