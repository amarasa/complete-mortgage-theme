...
$overlap_class = !empty($overlap) ? 'overlap' : '';
?>

<section class="branch-detail <?php echo esc_attr($classes); ?>" <?php echo $id; ?> data-block-name="<?php echo esc_attr($acfKey); ?>">
    <div class="branch-detail__panel xl:container mx-auto items-center px-8 py-12 lg:py-16 bg-[#ededed] <?php echo esc_attr($corners . ' ' . $overlap_class); ?>">
        ...
        <div class="grid grid-cols-12 lg:gap-x-16">
            <div class="col-span-12 lg:col-span-6 mb-8">
                <?php if (!empty($branch_info)): ?>
                    <div class="mb-8 wysiwyg branch-info-content"><?php echo $branch_info; ?></div>
                <?php endif; ?>

                <!-- Contact Information -->
                <?php if (!empty($contact_info)): ?>
                    <h3 class="uppercase 
                    !text-base tracking-widest !text-primary !mb-1">Contact Information</h3>

                    <div>
                        <?php echo $contact_info['address_1']; ?><br>
                    ...
                    <?php if (!empty($hours['show_hours']) && (!empty($hours['weekday_open']) || !empty($hours['saturday_open']))): ?>
                        <div class="mt-8">
                            <h3 class="uppercase !text-base tracking-widest !text-primary !mb-1">Hours</h3>
                    ...
                    <?php foreach ($cta_buttons as $button): ?>
                        <?php if (!empty($button['cta_button'])): ?>
                            <a href="<?php echo esc_url($button['cta_button']['url']); ?>"
                                ...
                                class="branch-detail__button button bg-secondary hover:bg-tertiary !block !w-full mb-4 !no-underline !text-white">
