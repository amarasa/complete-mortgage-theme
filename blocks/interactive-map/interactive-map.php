...
?>
<section class="interactive-map<?php echo esc_attr($classes); ?>" <?php echo $id; ?> data-block-name="<?php echo esc_attr($acfKey); ?>" data-highlighted-states="<?php echo esc_attr($js_states); ?>">
    <div class="container">
